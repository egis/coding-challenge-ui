...
Create a webapp that allows adding, editing and deleting contacts.  
Contacts **must** persist between page reloads

Technical spec
--------------

You are free to use any JS library available via npm or bower.
